...
InsideLSFcn::InsideLSFcn(const string& object_name, Pointer<Database> input_db, bool use_inside)
    : CartGridFunction(object_name), d_use_inside(use_inside)
{
#if !defined(NDEBUG)
