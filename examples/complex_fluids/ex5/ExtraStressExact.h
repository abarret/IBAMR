 ...
 */
class ExtraStressExact : public IBTK::CartGridFunction, public SAMRAI::solv::RobinBcCoefStrategy<NDIM>
{
public:
    /*!
     * \brief Constructor.
     */
    ExtraStressExact(std::string object_name, SAMRAI::tbox::Pointer<SAMRAI::tbox::Database> input_db, int depth);
