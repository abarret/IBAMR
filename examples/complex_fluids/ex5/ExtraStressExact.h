...
#ifndef included_ExtraStressExact
#define included_ExtraStressExact
 ...
 */
class ExtraStressExact : public IBTK::CartGridFunction,
...
public:
     ...
     * \brief Constructor.
     */
    ExtraStressExact(std::string object_name,
                     SAMRAI::tbox::Pointer<SAMRAI::tbox::Database> input_db,
                     int depth,
                     bool use_inside_solution);

    /*!
     * \brief Destructor.
     */
    ~ExtraStressExact() = default;
...
private:
    ...
    IBTK::MatrixNd exactValue(IBTK::VectorNd pt, double t) const;
    ...
    double d_la = std::numeric_limits<double>::quiet_NaN();

    int d_depth = -1;
    bool d_use_inside_solution = false;
};

/////////////////////////////// INLINE ///////////////////////////////////////

//#include "ExtraStressExact.I"

//////////////////////////////////////////////////////////////////////////////

#endif //#ifndef included_ExtraStressExact
