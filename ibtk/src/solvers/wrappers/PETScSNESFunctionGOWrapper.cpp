...
void
PETScSNESFunctionGOWrapper::apply(SAMRAIVectorReal<double>& x, SAMRAIVectorReal<NDIM, double>& y)
{
...
void
PETScSNESFunctionGOWrapper::initializeOperatorState(const SAMRAIVectorReal<double>& in,
