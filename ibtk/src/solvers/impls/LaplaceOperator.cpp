...
void
LaplaceOperator::setPhysicalBcCoef(RobinBcCoefStrategy* const bc_coef)
{
...
void
LaplaceOperator::setPhysicalBcCoefs(const std::vector<RobinBcCoefStrategy*>& bc_coefs)
{
...
const std::vector<RobinBcCoefStrategy*>&
