...
public:
     ...
     */
    void setOperator(std::shared_ptr<GeneralOperator> F);

    /*!
     * \brief Set the PETScNewtonKrylov solver using this object to compute
     * Jacobian-vector products.
     */
    void setNewtonKrylovSolver(std::shared_ptr<PETScNewtonKrylovSolver> nonlinear_solver);
     ...
     */
    void formJacobian(SAMRAI::solv::SAMRAIVectorReal<double>& u) override;
     ...
     */
    std::shared_ptr<SAMRAI::solv::SAMRAIVectorReal<double> > getBaseVector() const override;
...
private:
    ...
    std::shared_ptr<PETScNewtonKrylovSolver> d_nonlinear_solver;
    Mat d_petsc_jac = nullptr;
    std::shared_ptr<SAMRAI::solv::SAMRAIVectorReal<double> > d_op_u, d_op_x, d_op_y;
