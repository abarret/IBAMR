 ...
 */
class muParserRobinBcCoefs : public SAMRAI::solv::RobinBcCoefStrategy
{
public:
    /*!
     * \brief Constructor
     ...
     *time-dependent.
     */
    void setBcCoefs(const std::shared_ptr<SAMRAI::pdat::ArrayData<double> >& acoef_data,
            const std::shared_ptr<SAMRAI::pdat::ArrayData<double> >& bcoef_data,
            const std::shared_ptr<SAMRAI::pdat::ArrayData<double> >& gcoef_data,
     ...
     */
    SAMRAI::hier::IntVector numberOfExtensionsFillable() const override;
