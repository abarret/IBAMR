...
public:
     ...
     */
    std::shared_ptr<SAMRAI::tbox::Database> getInputDatabase();
     ...
     */
    std::shared_ptr<SAMRAI::tbox::Database> getRestartDatabase(bool suppress_warning = false);
     ...
     */
    std::shared_ptr<SAMRAI::tbox::Database> getComponentDatabase(const std::string& component_name,
     ...
     * returned.
     */
    std::shared_ptr<LSiloDataWriter> getLSiloDataWriter() const;
...
private:
     ...
     * The input database.
     */
    std::shared_ptr<SAMRAI::tbox::Database> d_input_db;
    ...
    std::shared_ptr<SAMRAI::appu::VisItDataWriter > d_visit_data_writer;
    std::shared_ptr<LSiloDataWriter> d_silo_data_writer;
