...
public:
     ...
     */
    static void setFromDatabase(std::shared_ptr<SAMRAI::tbox::Database> db);
     ...
     */
    template <class T>
    static void interpolate(std::shared_ptr<LData> Q_data,
                            std::shared_ptr<LData> X_data,
                            std::shared_ptr<LIndexSetData<T> > idx_data,
                            std::shared_ptr<SAMRAI::pdat::CellData<double> > q_data,
    ...
    static void interpolate(std::shared_ptr<LData> Q_data,
                            std::shared_ptr<LData> X_data,
                            std::shared_ptr<LIndexSetData<T> > idx_data,
                            std::shared_ptr<SAMRAI::pdat::NodeData<double> > q_data,
                            std::shared_ptr<SAMRAI::hier::Patch > patch,
                            const SAMRAI::hier::Box& interp_box,
                            const SAMRAI::hier::IntVector& periodic_shift,
                            const std::string& interp_fcn = "IB_4");
    ...
    static void interpolate(std::shared_ptr<LData> Q_data,
                            std::shared_ptr<LData> X_data,
                            std::shared_ptr<LIndexSetData<T> > idx_data,
                            std::shared_ptr<SAMRAI::pdat::SideData<double> > q_data,
                            std::shared_ptr<SAMRAI::hier::Patch > patch,
                            const SAMRAI::hier::Box& interp_box,
                            const SAMRAI::hier::IntVector& periodic_shift,
                            const std::string& interp_fcn = "IB_4");
    ...
    static void interpolate(std::shared_ptr<LData> Q_data,
                            std::shared_ptr<LData> X_data,
                            std::shared_ptr<LIndexSetData<T> > idx_data,
                            std::shared_ptr<SAMRAI::pdat::EdgeData<double> > q_data,
                            std::shared_ptr<SAMRAI::hier::Patch > patch,
                            const SAMRAI::hier::Box& interp_box,
                            const SAMRAI::hier::IntVector& periodic_shift,
                            const std::string& interp_fcn = "IB_4");
    ...
    static void interpolate(std::vector<double>& Q_data,
                            ...
                            const std::vector<double>& X_data,
                            int X_depth,
                            std::shared_ptr<SAMRAI::pdat::CellData<double> > mask_data,
                            std::shared_ptr<SAMRAI::pdat::CellData<double> > q_data,
                            std::shared_ptr<SAMRAI::hier::Patch > patch,
                            const SAMRAI::hier::Box& interp_box,
                            const std::string& interp_fcn = "IB_4");
    ...
    static void interpolate(std::vector<double>& Q_data,
                            ...
                            const std::vector<double>& X_data,
                            int X_depth,
                            std::shared_ptr<SAMRAI::pdat::SideData<double> > mask_data,
                            std::shared_ptr<SAMRAI::pdat::SideData<double> > q_data,
                            std::shared_ptr<SAMRAI::hier::Patch > patch,
                            const SAMRAI::hier::Box& interp_box,
                            const std::string& interp_fcn = "IB_4");
     ...
     */
    template <class T>
    static void spread(std::shared_ptr<SAMRAI::pdat::CellData<double> > q_data,
                       std::shared_ptr<LData> Q_data,
                       std::shared_ptr<LData> X_data,
                       std::shared_ptr<LIndexSetData<T> > idx_data,
                       std::shared_ptr<SAMRAI::hier::Patch > patch,
     ...
     */
    template <class T>
    static void spread(std::shared_ptr<SAMRAI::pdat::NodeData<double> > q_data,
                       std::shared_ptr<LData> Q_data,
                       std::shared_ptr<LData> X_data,
                       std::shared_ptr<LIndexSetData<T> > idx_data,
                       std::shared_ptr<SAMRAI::hier::Patch > patch,
     ...
     */
    template <class T>
    static void spread(std::shared_ptr<SAMRAI::pdat::SideData<double> > q_data,
                       std::shared_ptr<LData> Q_data,
                       std::shared_ptr<LData> X_data,
                       std::shared_ptr<LIndexSetData<T> > idx_data,
                       std::shared_ptr<SAMRAI::hier::Patch > patch,
     ...
     */
    template <class T>
    static void spread(std::shared_ptr<SAMRAI::pdat::EdgeData<double> > q_data,
                       std::shared_ptr<LData> Q_data,
                       std::shared_ptr<LData> X_data,
                       std::shared_ptr<LIndexSetData<T> > idx_data,
                       std::shared_ptr<SAMRAI::hier::Patch > patch,
     ...
     * \warning This method does \em not support periodic offsets for positions.
     */
    static void spread(std::shared_ptr<SAMRAI::pdat::CellData<double> > mask_data,
                       std::shared_ptr<SAMRAI::pdat::CellData<double> > q_data,
                       const std::vector<double>& Q_data,
                       int Q_depth,
                       const std::vector<double>& X_data,
     ...
     * \warning This method does \em not support periodic offsets for positions.
     */
    static void spread(std::shared_ptr<SAMRAI::pdat::SideData<double> > mask_data,
                       std::shared_ptr<SAMRAI::pdat::SideData<double> > q_data,
                       const std::vector<double>& Q_data,
                       int Q_depth,
                       const std::vector<double>& X_data,
