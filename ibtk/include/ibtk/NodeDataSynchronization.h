...
#ifndef included_IBTK_NodeDataSynchronization
#define included_IBTK_NodeDataSynchronization
 ...
 */
class NodeDataSynchronization : public 
{
public:
    /*!
     * \brief Class NodeDataSynchronization::SynchronizationTransactionComponent
    ...
    {
    public:
        friend class NodeDataSynchronization;
...
private:
    ...
    std::array<std::shared_ptr<SAMRAI::xfer::RefineAlgorithm >, NDIM> d_refine_alg;
    std::array<std::vector<std::shared_ptr<SAMRAI::xfer::RefineSchedule > >, NDIM> d_refine_scheds;
};
} // namespace IBTK

//////////////////////////////////////////////////////////////////////////////

#endif //#ifndef included_IBTK_NodeDataSynchronization
