...
#ifndef included_CFOneSidedUpperConvectiveOperator
#define included_CFOneSidedUpperConvectiveOperator
...
{
/*!
 * \brief Class CFOneSidedUpperConvectiveOperator is a concrete ConvectiveOperator that implements the upper convective
...
class CFOneSidedUpperConvectiveOperator : public ConvectiveOperator
{
public:
    // Constructor
    CFOneSidedUpperConvectiveOperator(const std::string& object_name,
    ...
    CFOneSidedUpperConvectiveOperator() = delete;

    CFOneSidedUpperConvectiveOperator(const CFOneSidedUpperConvectiveOperator& from) = delete;

    CFOneSidedUpperConvectiveOperator& operator=(const CFOneSidedUpperConvectiveOperator& that) = delete;

    // Destructor
    ~CFOneSidedUpperConvectiveOperator();
