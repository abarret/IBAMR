...
#ifndef included_OldroydB_RHS
#define included_OldroydB_RHS
 ...
 */
class OldroydB_RHS : public RHS_Operator
{
public:
    /*!
     ...
     * grid.
     */
    OldroydB_RHS(const std::string& object_name,
...
private:
     ...
     */
    OldroydB_RHS(const OldroydB_RHS& from);
     ...
     */
    OldroydB_RHS& operator=(const OldroydB_RHS& that);
