...
#ifndef included_RoliePoly_RHS
#define included_RoliePoly_RHS
 ...
 */
class RoliePoly_RHS : public RHS_Operator
{
public:
    /*!
...
private:
     ...
     */
    RoliePoly_RHS(const RoliePoly_RHS& from);
     ...
     */
    RoliePoly_RHS& operator=(const RoliePoly_RHS& that);
